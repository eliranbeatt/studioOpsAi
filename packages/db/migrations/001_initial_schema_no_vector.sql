...
-- Migration 001: Create all core tables (without vector extension)
...
-- Vector storage for chunks/memories (commented out for now)
...
--     page INTEGER,
--     text TEXT,
--     embedding BYTEA, -- Using BYTEA instead of VECTOR
--     created_at TIMESTAMPTZ DEFAULT NOW()
-- );
